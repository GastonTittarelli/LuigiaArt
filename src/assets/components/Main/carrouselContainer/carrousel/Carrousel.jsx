...
export default function Appli() {
    ...
    const handleMouseMove = (index, e) => {
        ...
        if (zoomRef) {
            ...
            const x = ((e.clientX - rect.left) / rect.width) * 100; // Calcula coordenada X 
            const y = ((e.clientY - rect.top) / rect.height) * 100; // Calcula coordenada Y 
    
            setZoomStyle({
                transformOrigin: `${x}% ${y}%`,
                transform: 'scale(2.5)' // Nivel de zoom 
            });
        }
    };
